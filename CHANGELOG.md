# Upstream MEGAHIT changelog

This file records the upstream MEGAHIT history through v1.2.9. RabbitMA starts
from that source base; RabbitMA-specific changes are summarized in the main
